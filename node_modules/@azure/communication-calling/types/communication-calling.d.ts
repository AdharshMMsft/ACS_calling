...
export declare interface CallCommon extends Disposable {
    ...
    /**
     * Subscribe function for meetingCapabilitiesChanged event.
     * @param event - event name.
     * @param listener - callback fn that will be called when value of this property will change.
     * @beta
     */
...
declare interface IVideoEffectsStatusManager {
    getActiveEffects(): VideoEffectName[];
    setActiveEffects(effects: VideoEffectName[]): void;
    on(event: 'statusChanged', listener: VideoEffectsStatusChangedListener): void;
    off(event: 'statusChanged', listener: VideoEffectsStatusChangedListener): void;
}
...
declare type VideoEffectsStatusChangedListener = (oldStatus: VideoEffectName[], newStatus: VideoEffectName[]) => void;
